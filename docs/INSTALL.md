...
1. Releaseから `liked-media-masonry-chrome-v0.15.0.zip` と `SHA256SUMS.txt` を取得します。
...
1. Releaseから `liked-media-masonry-firefox-floorp-v0.15.0.xpi` と `SHA256SUMS.txt` を取得します。
2. SHA-256を確認します。
...
```powershell
Get-FileHash .\liked-media-masonry-chrome-v0.15.0.zip -Algorithm SHA256
Get-FileHash .\liked-media-masonry-firefox-floorp-v0.15.0.xpi -Algorithm SHA256
...
```bash
sha256sum liked-media-masonry-chrome-v0.15.0.zip
sha256sum liked-media-masonry-firefox-floorp-v0.15.0.xpi
cat SHA256SUMS.txt
```
